...
const viewHome = () => {
  ...
  return (
    <div className="h-screen w-1/12 p-4 border-r border-gray-300 items-center bg-white flex flex-col ">
    ...
    <div className="p-2 rounded-lg mt-[400%] flex flex-col items-center justify-center w-11/12 cursor-pointer" onClick={logout}>
